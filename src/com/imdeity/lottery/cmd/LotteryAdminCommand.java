...
//        output.add(ChatTools.formatCommand("", "/lotteryadmin", "config", "Gives help on configuaration."));
        output.add(ChatTools.formatCommand("", "/lotteryadmin", "addtopot [n]", "Adds [n] to current pot."));
        output.add(ChatTools.formatCommand("", "/lotteryadmin", "removefrompot [n]", "Removes [n] to current pot."));
        output.add(ChatTools.formatCommand("", "/lotteryadmin", "draw", "Forces a draw of t."));
    }
...
//        } else if (split[0].equalsIgnoreCase("config") || split[0].equalsIgnoreCase("c")) {
//           config(player, split);
